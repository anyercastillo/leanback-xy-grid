...
class MainFragment : BrowseSupportFragment() {
    ...
    /**
     * Registers [PageRow]s into the [BrowseSupportFragment] architecture.
     *
     * Notice it is a recommendation from Google to register [PageRow]s in
     * the constructor of [BrowseSupportFragment].
     *
     * https://youtu.be/QFHIfQy8_Wc?list=LL&t=772
     */
